...
2. **Runtime injection pipeline** (`installer/`):
   ...
   - Presets: 3 built-in themes in `manager/presets.json` (backgrounds referenced as `asset://`, embedded at assembly). Built-ins never enter IndexedDB; editing one saves a copy.
